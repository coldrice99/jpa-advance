...
//    void test5() {
//        Food food = foodRepository.findById(Math.toIntExact(1L)).orElseThrow(NullPointerException::new);
//        // 음식 정보 조회
...
//    void test6() {
//        User user = userRepository.findById(Math.toIntExact(1L)).orElseThrow(NullPointerException::new);
//        // 고객 정보 조회
